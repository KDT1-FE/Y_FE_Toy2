          ...
          <CateLink>
            <div className="catelink__wrap">
              ...
              <div className="catelink__name">
                ...
                <p className="content">비밀메시지1줄넘침처리비밀메시지1줄넘침처리</p>
              </div>
              <div className="catelink__time">
                1시간 전
              </div>
            </div>
          </CateLink>
        ...
        <ChatRoom>
          <div className="chatroom__tit">
            <div className="tit-bx">
              ...
              <p className="tit">수다수다방</p>
              <p className="count"><img src="/src/assets/images/user-ico.png" width="14"></img><span className="num">2</span></p>
            </div>
          ...
          <div className="chatroom__body">
            <div className="scroll-inner">
              ...
              <div className="message message__left">
                ...
                <div className="content">
                  <div className="inner">
                    ...
                    <span className="bubble">안녕하세요 내용 더 추가 안녕하세요? 무슨할말이있는고 무슨말인데??</span>
                  </div>
              ...
              <div className="message message__right">
                <div className="content">
                  <div className="inner">
                    <span className="bubble">안녕하세요 내용 더 추가 안녕하세요? 어디까지? 여기까지</span>
                  </div>
                  <div className="date">오전 10:30</div>
                </div>
              </div>
          ...
          <div className="chatroom__send">
            <input type="text" />
            <button>
              <img src="/src/assets/images/up-arrow-ico.png" alt="화살표" width="20"/>
            </button>
          </div>
        </ChatRoom>
      </ChatWrapper>
